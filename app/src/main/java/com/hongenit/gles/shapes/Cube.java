...
public class Cube extends BaseShape{
    ...
    private void createProgram() {
        ...
        // 获取程序链接的状态
        GLES20.glGetProgramiv(mProgram, GLES20.GL_LINK_STATUS, glLinkStatus, 0);
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        LogUtils.hong("cube onSurfaceCreated = ");
        createProgram();
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        LogUtils.hong("cube onSurfaceChanged = ");
        //计算宽高比
    ...
    public void onDrawFrame(GL10 gl) {
        LogUtils.hong("cube------onDrawFrame------ = ");
